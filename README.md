...
```shell
torchrun --nproc_per_node=1 train.py -f -f configs/damoyolo_tinynasL25_S.py
```
</details>
...
```shell
torchrun --nproc_per_node=1 eval.py -f tools/eval.py -f configs/damoyolo_tinynasL25_S.py --ckpt /path/to/your/damoyolo_tinynasL25_S.pth
```
</details>
